      ...
      <div className="grid grid-cols-2 py-11 px-20 gap-12 mt-14 bg-ruby rounded-3xl z-10 relative">
        ...
        <div id="first-col">
          ...
          <p className="text-white/[0.6] font-medium leading-relaxed">
            ...
            leverages Zytron L3, Z4 Engine, and B² blockchain to provide a transparent, provably fair
        ...
        <div id="second-col" className="flex flex-col gap-6">
          ...
          <div className="border border-[#E504983D] p-5 flex flex-col gap-3 inner-purple-shadow rounded-xl">
            ...
            <p className="text-white">
            Users can stake tokens in virtual liquidity pools to earn APTC tokens, which are used for betting, gaming, and rewards. (Zytron L3, Z4 Engine, and B² Tokens are equivalent to in-game currency token APTC)

            </p>
            <ul className="list-disc pl-6 text-white mt-2">
              <li>Leverages Zytron L3, Z4 Engine, and B² Protocol’s unified liquidity to eliminate slippage and ensure efficient gameplay across multiple chains.
